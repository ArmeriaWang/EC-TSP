...
public class SGAlgo1 extends SimpleGeneticAlgo {
    ...
    protected SGAlgo1(int IndividualNum, int generationCntUpper) {
    ...
    public int solve(TSPProblem problem) throws IOException {
        ...
        logName = problem.getName() + "_algo1_" + sysTime + ".txt";
        createLog(logName);
        ...
        while (true) {
            ...
            Population matingPool = population.tournamentSelection(problem);
